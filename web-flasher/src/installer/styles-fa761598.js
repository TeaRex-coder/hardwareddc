    ...
    : (t) =>
        t instanceof CSSStyleSheet
          ? ((t) => {
              ...
              return ((t) =>
                new c("string" == typeof t ? t : t + "", void 0, s))(e);
            })(t)
          : t;
var u;
const m = window,
  ...
  b = (t, e) => e !== t && (e == e || t == t),
  y = { attribute: !0, type: String, converter: v, reflect: !1, hasChanged: b },
  _ = "finalized";
let x = class extends HTMLElement {
  ...
  requestUpdate(t, e, i) {
    let o = !0;
    void 0 !== t &&
      (((i = i || this.constructor.getPropertyOptions(t)).hasChanged || b)(
        this[t],
        e
      )
...
(x[_] = !0),
  ...
  (null !== (u = m.reactiveElementVersions) && void 0 !== u
    ? u
    ...
    for (let e = 0; e < i; e++) {
      ...
      n +=
        a === H
          ? i + k
          : c >= 0
          ? (o.push(s), i.slice(0, c) + C + i.slice(c) + T + p)
          : i + T + (-2 === c ? (o.push(void 0), e) : p);
    }
  ...
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    for (; null !== (o = W.nextNode()) && s.length < a; ) {
      if (1 === o.nodeType) {
        ...
        if (o.data === R) s.push({ type: 2, index: r });
        else {
          let t = -1;
          for (; -1 !== (t = o.data.indexOf(T, t + 1)); )
            s.push({ type: 7, index: r }), (t += T.length - 1);
        }
      r++;
    }
  }
  ...
  return (
    (null == d ? void 0 : d.constructor) !== c &&
      (null === (n = null == d ? void 0 : d._$AO) ||
        void 0 === n ||
        n.call(d, !1),
      void 0 === c ? (d = void 0) : ((d = new c(t)), d._$AT(t, i, o)),
      void 0 !== o
    ...
    for (; void 0 !== d; ) {
      if (a === d.index) {
        ...
        2 === d.type
          ...
          : 6 === d.type && (e = new nt(n, this, t)),
          this._$AV.push(e),
          (d = o[++s]);
      }
      a !== (null == d ? void 0 : d.index) && ((n = W.nextNode()), a++);
    }
    return (W.currentNode = $), r;
  }
  v(t) {
    let e = 0;
...
class Q {
  ...
  _(t) {
    this._$AH !== K && I(this._$AH)
      ? (this._$AA.nextSibling.data = t)
      : this.$($.createTextNode(t)),
      (this._$AH = t);
  }
  g(t) {
    var e;
    const { values: i, _$litType$: o } = t,
      r =
        "number" == typeof o
          ? this._$AC(t)
          : (void 0 === o.el && (o.el = X.createElement(o.h, this.options)), o);
  ...
  T(t) {
    ...
    for (const r of t)
      o === e.length
        ? e.push((i = new Q(this.k(O()), this.k(O()), this, this.options)))
        : (i = e[o]),
        i._$AI(r),
        o++;
...
null == at || at(X, Q),
  (null !== (E = A.litHtmlVersions) && void 0 !== E
    ? E
    : (A.litHtmlVersions = [])
  ).push("2.7.4");
var st, dt;
...
(ct.finalized = !0),
  ...
  null === (st = globalThis.litElementHydrateSupport) ||
    void 0 === st ||
    st.call(globalThis, { LitElement: ct });
const lt = globalThis.litElementPolyfillSupport;
null == lt || lt({ LitElement: ct }),
  (null !== (dt = globalThis.litElementVersions) && void 0 !== dt
    ? dt
...
const gt =
  ...
  (i, o) => {
    ...
    }
    {
      ...
      void 0 !== e && Object.defineProperty(i, o, e(o)), null == t || t(r, o);
    }
  };
function vt(t) {
  return gt({
...
const xt =
  null !=
  (null === (_t = window.HTMLSlotElement) || void 0 === _t
    ? void 0
    : _t.prototype.assignedElements)
...
(wt.styles = [At]), (wt = o([pt("mwc-icon")], wt));
...
document.addEventListener("x", Rt, kt), document.removeEventListener("x", Rt);
const $t = (t = window.document) => {
    let e = t.activeElement;
    const i = [];
    if (!e) return i;
    for (; e && (i.push(e), e.shadowRoot); ) e = e.shadowRoot.activeElement;
    return i;
  },
  Ot = (t) => {
    const e = $t();
            ...
            if (!(o && void 0 !== t && o.type !== t.type))
              (i.isActivated = !0),
                ...
                Mt.some(function (t) {
                  ...
                  : (void 0 !== t &&
                      (Mt.push(t.target), this.registerDeactivationHandlers(t)),
      ...
      update(t, [e]) {
        ...
        for (const t in e) {
          ...
          i === this.it.has(t) ||
            ...
            (i ? (r.add(t), this.it.add(t)) : (r.remove(t), this.it.delete(t)));
        }
        return G;
      }
    }
      ...
      update(t, [e]) {
        ...
        for (const t in e) {
          ...
          if (null != o) {
            ...
            t.includes("-") || e
              ? i.setProperty(t, e ? o.slice(0, -11) : o, e ? Kt : "")
              : (i[t] = o);
          }
        }
        return G;
...
o([bt(".mdc-ripple-surface")], Yt.prototype, "mdcRoot", void 0),
  o([ht({ type: Boolean })], Yt.prototype, "primary", void 0),
  o([ht({ type: Boolean })], Yt.prototype, "accent", void 0),
  o([ht({ type: Boolean })], Yt.prototype, "unbounded", void 0),
  o([ht({ type: Boolean })], Yt.prototype, "disabled", void 0),
  o([ht({ type: Boolean })], Yt.prototype, "activated", void 0),
  o([ht({ type: Boolean })], Yt.prototype, "selected", void 0),
  o(
    [ht({ type: Boolean })],
    Yt.prototype,
...
function Jt(t, e, i) {
  if (void 0 !== e)
    return (function (t, e, i) {
      ...
      const r = i;
      let n = "";
      if (!r.set) throw new Error(`@ariaProperty requires a setter for ${e}`);
      ...
      const a = {
        ...
        set(t) {
          ...
          this.hasAttribute(n) && this.removeAttribute(n), r.set.call(this, t);
        },
      };
      return (
        r.get &&
...
(Zt.styles = [Xt]), (Zt = o([pt("mwc-ripple")], Zt));
class Qt {
  constructor(t) {
    (this.startPress = (e) => {
      t().then((t) => {
...
class ee extends ct {
  ...
  renderRipple() {
    ...
    return this.shouldRenderRipple
      ? V`<mwc-ripple class="ripple" .primary="${!t}" .disabled="${
          this.disabled
        }"></mwc-ripple>`
      : "";
  }
...
(ee.shadowRootOptions = { mode: "open", delegatesFocus: !0 }),
  o(
    [Jt, ht({ type: String, attribute: "aria-haspopup" })],
    ee.prototype,
    "ariaHasPopup",
    void 0
  ),
  o([ht({ type: Boolean, reflect: !0 })], ee.prototype, "raised", void 0),
  o([ht({ type: Boolean, reflect: !0 })], ee.prototype, "unelevated", void 0),
  o([ht({ type: Boolean, reflect: !0 })], ee.prototype, "outlined", void 0),
  o([ht({ type: Boolean })], ee.prototype, "dense", void 0),
  o([ht({ type: Boolean, reflect: !0 })], ee.prototype, "disabled", void 0),
  o(
    [ht({ type: Boolean, attribute: "trailingicon" })],
    ee.prototype,
    "trailingIcon",
    void 0
  ),
  o([ht({ type: Boolean, reflect: !0 })], ee.prototype, "fullwidth", void 0),
  o([ht({ type: String })], ee.prototype, "icon", void 0),
  o([ht({ type: String })], ee.prototype, "label", void 0),
  o([ht({ type: Boolean })], ee.prototype, "expandContent", void 0),
  ...
  o([vt({ passive: !0 })], ee.prototype, "handleRippleActivate", null);
...
(oe.styles = [
  ...
  (() => {
    ...
    class g {
      ...
      push(t) {
        t && t !== this.top && (this.remove(t), this[d](t), this[o].push(t));
      }
      remove(t) {
        const e = this[o].indexOf(t);
        return (
          -1 !== e &&
          (this[o].splice(e, 1), e === this[o].length && this[d](this.top), !0)
        );
      }
      pop() {
        const t = this.top;
      ...
      [((t = o), (e = n), (i = r), d)](t) {
        ...
        this[n] = o;
        const a = this[m](t);
        if (!i.length) return void this[l](o, a, e);
        let s = i.length - 1,
          d = o.length - 1;
        for (; s > 0 && d > 0 && i[s] === o[d]; ) s--, d--;
      ...
      [l](t, e, i) {
        for (const o of t) {
          ...
          let c = t;
          const l = c;
          l.__shady && l.host && (c = l.host), d.observe(c, { childList: !0 });
        }
      }
      [f](t) {
        const e = this[n],
        ...
        for (const o of t) {
          ...
          for (let t = 0; t < o.addedNodes.length; t++) {
            ...
            this[h](e) &&
              (i && e.inert ? i.add(e) : ((e.inert = !0), s.add(e)));
          }
        }
      }
      [h](t) {
      ...
      [m](t) {
        ...
        if (a.length && a[0].assignedNodes)
          for (o = 0; o < a.length; o++)
            for (
              n = a[o].assignedNodes({ flatten: !0 }), r = 0;
              r < n.length;
              r++
            )
...
!(function () {
          ...
          re(i, [
                ...
                if (e) {
                  ...
                  if (
                    ...
                    for (var r = t.parentNode; r; )
                      11 === r.nodeType && d(r), (r = r.parentNode);
                } else {
                  if (!this._inertRoots.has(t)) return;
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  void 0 !== i ? i.addInertRoot(e) : (i = new r(t, e)),
  ...
  function s(t, e, i) {
    ...
    for (var u = t.firstChild; null != u; ) s(u, e), (u = u.nextSibling);
  }
  function d(t) {
...
var pe = (function (t) {
  ...
  return (
    ...
    (o.prototype.open = function (t) {
      ...
      (this.dialogOpen = !0),
        ...
        t &&
          ...
          this.adapter.addClass(se.SCRIM_HIDDEN),
    ...
    (o.prototype.handleClick = function (t) {
      if (
        this.adapter.eventTargetMatches(t.target, de.SCRIM_SELECTOR) &&
    ...
    (o.prototype.toggleScrollableClasses = function () {
      this.adapter.removeClass(se.SCROLLABLE),
        this.adapter.isContentScrollable() &&
          (this.adapter.addClass(se.SCROLLABLE),
          this.isFullscreen &&
    ...
    (o.prototype.toggleScrollDividerHeader = function () {
      this.adapter.isScrollableContentAtTop()
        ? this.adapter.hasClass(se.SCROLL_DIVIDER_HEADER) &&
          this.adapter.removeClass(se.SCROLL_DIVIDER_HEADER)
        : this.adapter.addClass(se.SCROLL_DIVIDER_HEADER);
    }),
    (o.prototype.toggleScrollDividerFooter = function () {
      this.adapter.isScrollableContentAtBottom()
        ? this.adapter.hasClass(se.SCROLL_DIVIDER_FOOTER) &&
          this.adapter.removeClass(se.SCROLL_DIVIDER_FOOTER)
        : this.adapter.addClass(se.SCROLL_DIVIDER_FOOTER);
    }),
    o
  );
})(Nt);
...
class fe extends It {
  ...
  getInitialFocusEl() {
    ...
    if (o) return o;
    const r = this.secondarySlot.assignedNodes({ flatten: !0 }),
  ...
  createAdapter() {
    return Object.assign(Object.assign({}, Tt(this.mdcRoot)), {
      ...
      trapFocus: (t) => {
        this.isConnected && (he.push(this), t && t.focus());
      },
  ...
  render() {
    const t = { [se.STACKED]: this.stacked };
    let e = V``;
  ...
  setEventListeners() {
    this.boundHandleClick &&
      ...
      this.boundHandleKeydown &&
        this.mdcRoot.addEventListener("keydown", this.boundHandleKeydown, ue()),
      this.boundHandleDocumentKeydown &&
...
o([bt(".mdc-dialog")], fe.prototype, "mdcRoot", void 0),
  ...
  o([ht({ type: Boolean })], fe.prototype, "hideActions", void 0),
  o(
    [
      ht({ type: Boolean }),
      me(function () {
  ...
  o([ht({ type: String })], fe.prototype, "heading", void 0),
  o(
    [
      ht({ type: String }),
      me(function (t) {
